...
static const gui_element_t psg_gui [ELEMENT_COUNT] = {
    [ELEMENT_CH0_VOLUME] = {
        ...
        .cursor_x = 35, .cursor_y = 23, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_CH0_MODE_KEYBOARD] = {
        ...
        .cursor_x = 59, .cursor_y = 31, .cursor_w = 34, .cursor_h = 16,
    ...
    [ELEMENT_CH0_MODE_CONSTANT] = {
        ...
        .cursor_x = 97, .cursor_y = 31, .cursor_w = 22, .cursor_h = 16,
    ...
    [ELEMENT_CH0_FREQUENCY] = {
        ...
        .cursor_x = 129, .cursor_y = 23, .cursor_w = 38, .cursor_h = 25,
    ...
    [ELEMENT_CH0_BUTTON] = {
        ...
        .cursor_x = 179, .cursor_y = 23, .cursor_w = 48, .cursor_h = 18,
    ...
    [ELEMENT_CH1_VOLUME] = {
        ...
        .cursor_x = 35, .cursor_y = 47, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_CH1_MODE_KEYBOARD] = {
        ...
        .cursor_x = 59, .cursor_y = 55, .cursor_w = 34, .cursor_h = 16,
    ...
    [ELEMENT_CH1_MODE_CONSTANT] = {
        ...
        .cursor_x = 97, .cursor_y = 55, .cursor_w = 22, .cursor_h = 16,
    ...
    [ELEMENT_CH1_FREQUENCY] = {
        ...
        .cursor_x = 129, .cursor_y = 47, .cursor_w = 38, .cursor_h = 25,
    ...
    [ELEMENT_CH1_BUTTON] = {
        ...
        .cursor_x = 179, .cursor_y = 47, .cursor_w = 48, .cursor_h = 18,
    ...
    [ELEMENT_CH2_VOLUME] = {
        ...
        .cursor_x = 35, .cursor_y = 71, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_CH2_MODE_KEYBOARD] = {
        ...
        .cursor_x = 59, .cursor_y = 79, .cursor_w = 34, .cursor_h = 16,
    ...
    [ELEMENT_CH2_MODE_CONSTANT] = {
        ...
        .cursor_x = 97, .cursor_y = 79, .cursor_w = 22, .cursor_h = 16,
    ...
    [ELEMENT_CH2_FREQUENCY] = {
        ...
        .cursor_x = 129, .cursor_y = 71, .cursor_w = 38, .cursor_h = 25,
    ...
    [ELEMENT_CH2_BUTTON] = {
        ...
        .cursor_x = 179, .cursor_y = 71, .cursor_w = 48, .cursor_h = 18,
    ...
    [ELEMENT_NOISE_VOLUME] = {
        ...
        .cursor_x = 35, .cursor_y = 95, .cursor_w = 18, .cursor_h = 25,
    ...
    [ELEMENT_NOISE_MODE_KEYBOARD] = {
        ...
        .cursor_x = 59, .cursor_y = 103, .cursor_w = 34, .cursor_h = 16,
    ...
    [ELEMENT_NOISE_MODE_CONSTANT] = {
        ...
        .cursor_x = 97, .cursor_y = 103, .cursor_w = 22, .cursor_h = 16,
    ...
    [ELEMENT_NOISE_CONTROL] = {
        ...
        .cursor_x = 129, .cursor_y = 95, .cursor_w = 38, .cursor_h = 24,
    ...
    [ELEMENT_NOISE_BUTTON] = {
        ...
        .cursor_x = 179, .cursor_y = 95, .cursor_w = 48, .cursor_h = 18,

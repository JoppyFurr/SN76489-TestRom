...
{
    /* TODO: Can we make it so diagonals work?
     *       Would probably need to handle two
     *       direction changes in a single frame.
     *       We'd need to make sure cursor_tick ()
     *       only gets called the once, so maybe
